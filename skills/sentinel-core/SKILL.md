...
> **For the full hunting methodology** — 5-phase non-linear workflow, developer psychology framework, session discipline, tool routing by phase, and Wide/Deep route selection — see **`skills/hunt-mindset/SKILL.md`**.
...
git clone https://github.com/mlvpatel/sentinel-ai-offensive.git ~/.claude/skills/sentinel-core
ln -s ~/.claude/skills/sentinel-core/SKILL.md ~/.claude/skills/sentinel-core/SKILL.md

# Option B: Direct copy
mkdir -p ~/.claude/skills/sentinel-core
curl -s https://raw.githubusercontent.com/mlvpatel/sentinel-ai-offensive/main/SKILL.md \
  -o ~/.claude/skills/sentinel-core/SKILL.md
```
